...
<head>
    ...
    <title>Trayectoria 1 de <?php echo $numControl?></title>
...
<body>
    <h1>Trayectoria 1er Semestre de <?php echo $numControl?></h1>
    <table id="resultados_tsem">
        <?php
        $qTS = "SELECT tr.*, al.nombre, al.apellidos FROM trayectoria_sem1 tr
        ...
        <tr>
            <th class="th_rtsem">Suma de Créditos AE:</th>
