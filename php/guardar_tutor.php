...
require "fecha_hora.php";
    ...
    $t_tutor = "INSERT INTO tutor (nombre,apellido,tipo_tutoria,area_de,email,fecha_registro,hora_registro,usuario,pass_tutor)
                VALUES ('$nombre','$apellido','$tutoria','$area','$correo','$fechaHoy','$horaHoy','$usuario','$passnormal')";
