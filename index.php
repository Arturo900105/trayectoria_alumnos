...
<html lang="es">
    ...
    <body>
        ...
        <a href="javascript:accesoCITA('sesion_coordinador.php')">
            <input type="button" value="COORDINADOR" class="boton_acceso" title="Acceso solo para el Personal de Tutaría Académica">
        </a>
