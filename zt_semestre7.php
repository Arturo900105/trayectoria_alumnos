...
<head>
    ...
    <title>Trayectoria 7 de <?php echo $numControl?></title>
...
<body>
    <h1>Trayectoria 7mo Semestre de <?php echo $numControl?></h1>
    <table id="resultados_tsem">
        <?php
        $qTS = "SELECT tr.*, al.nombre, al.apellidos FROM trayectoria_sem7 tr
        ...
        while ($fTS = $rTS->fetch_assoc()){
            ...
            <tr>
                <th class="th_rtsem">Servicio Social:</th>
                <td class="td_rtsem"><?php echo $fTS['servicio_social'] ?></td>
            </tr>
            <tr>
                <th class="th_rtsem">Lugar donde realiza el Servicio Social:</th>
                <td class="td_rtsem"><?php echo $fTS['lugar_servsocial'] ?></td>
            </tr>
            <tr>
