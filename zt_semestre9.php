...
<head>
    ...
    <title>Trayectoria 9 de <?php echo $numControl?></title>
...
<body>
    <h1>Trayectoria 9no Semestre de <?php echo $numControl?></h1>
    <table id="resultados_tsem">
        <?php
        $qTS = "SELECT tr.*, al.nombre, al.apellidos FROM trayectoria_sem9 tr
        ...
        while ($fTS = $rTS->fetch_assoc()){
            ...
            <tr>
                <th class="th_rtsem">Residencias Profecionales:</th>
                <td class="td_rtsem"><?php echo $fTS['residencia_profesional'] ?></td>
            </tr>
            <tr>
                <th class="th_rtsem">Lugar donde realiza las Residencias Profecionales:</th>
                <td class="td_rtsem"><?php echo $fTS['lugar_resiprof'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <th class="th_rtsem">Observaciones Agosto - Diciembre:</th>
                <td class="td_rtsem"><?php echo $fTS['observacion_ago_dic'] ?></td>
            </tr>
            <tr>
