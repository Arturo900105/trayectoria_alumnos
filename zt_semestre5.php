...
<head>
    ...
    <title>Trayectoria 5 de <?php echo $numControl?></title>
...
<body>
    <h1>Trayectoria 5to Semestre de <?php echo $numControl?></h1>
    <table id="resultados_tsem">
        <?php
        $qTS = "SELECT tr.*, al.nombre, al.apellidos FROM trayectoria_sem5 tr
