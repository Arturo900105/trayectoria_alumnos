...
<head>
    ...
    <title>Trayectoria 2 de <?php echo $numControl?></title>
...
<body>
    <h1>Trayectoria 2do Semestre de <?php echo $numControl?></h1>
    <table id="resultados_tsem">
        <?php
        $qTS = "SELECT tr.*, al.nombre, al.apellidos FROM trayectoria_sem2 tr
