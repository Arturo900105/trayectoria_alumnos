...
<head>
    ...
    <title>I. Técnicas de Estudio</title>
...
<body>
    <h1>INTERPRETACIÓN<br>TÉCNICAS DE ESTUDIO<br>GENERACIÓN <?php echo $generacion ?>:</h1>
    ...
    <table class="tablas_otme">
        ...
        <tbody>
        <?php
        $QT_CAPPT = "SELECT  al.carrera, al.generacion, tp.tecnicas_estudio FROM tabla_pedagogia tp
        ...
        function sumarFila($arg_1, $arg_2) {
            if ($arg_1['tecnicas_estudio'] == 20){
                ++$arg_2[0];
            }
            if ($arg_1['tecnicas_estudio'] == 18 || $arg_1['tecnicas_estudio'] == 19) {
                ++$arg_2[1];
            }
            if ($arg_1['tecnicas_estudio'] == 17) {
                ++$arg_2[2];
            }
            if ($arg_1['tecnicas_estudio'] == 16) {
                ++$arg_2[3];
            }
            if ($arg_1['tecnicas_estudio'] == 14 || $arg_1['tecnicas_estudio'] == 15) {
                ++$arg_2[4];
            }
            if ($arg_1['tecnicas_estudio'] == 13) {
                ++$arg_2[5];
            }
            if ($arg_1['tecnicas_estudio'] == 12) {
                ++$arg_2[6];
            }
            if ($arg_1['tecnicas_estudio'] == 11) {
                ++$arg_2[7];
            }
            if ($arg_1['tecnicas_estudio'] >= 0 && $arg_1['tecnicas_estudio'] <= 10) {
                ++$arg_2[8];
            }
            return $arg_2;
        }
